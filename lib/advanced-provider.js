...
// API_URL ='https://cdn.rawgit.com/lonekorean/atom-autocomplete-boilerplate/55500674/data/advanced.json';
API_URL='https://bitbucket.org/nagendrakommireddi/autocomplete-plus/src/b89c625b01c8/data/advanced.json';
// API_URL = "http://localhost:8000/advanced.json"
class AdvancedProvider {
	constructor() {
		// offer suggestions only when editing plain text or HTML files
		this.selector = '.text.plain, .text.html.basic, .source.yaml';
...
//		if (prefix.startsWith('([a-zA-Z][-a-zA-Z]*)=\s*$/')) {
